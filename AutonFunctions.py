...
BotDriveTrain = DriveTrain(left_motors, right_motors, 300, 320, 320, MM, 1)
...
def user_control():
    ...
    while True:
        ...
        BotDriveTrain.set_drive_velocity(x, PERCENT)
        brain.screen.print(x)
        BotDriveTrain.set_turn_velocity(controller.axis2.position(), PERCENT)
...
# BotDriveTrain.drive(FORWARD)
# BotDriveTrain.turn(RIGHT)
